...
var mathModule = map[string]tengo.Object{
	...
	"sqrt_e":                   &tengo.Float{Value: math.SqrtE},
	"sqrt_pi":                  &tengo.Float{Value: math.SqrtPi},
	"sqrt_phi":                 &tengo.Float{Value: math.SqrtPhi},
	"ln2":                      &tengo.Float{Value: math.Ln2},
	"log2_e":                   &tengo.Float{Value: math.Log2E},
	"ln10":                     &tengo.Float{Value: math.Ln10},
	"log10_e":                  &tengo.Float{Value: math.Log10E},
	"max_float32":              &tengo.Float{Value: math.MaxFloat32},
	"smallest_nonzero_float32": &tengo.Float{Value: math.SmallestNonzeroFloat32},
	"max_float64":              &tengo.Float{Value: math.MaxFloat64},
	"smallest_nonzero_float64": &tengo.Float{Value: math.SmallestNonzeroFloat64},
	"max_int":                  &tengo.Int{Value: math.MaxInt},
	"min_int":                  &tengo.Int{Value: math.MinInt},
	"max_int8":                 &tengo.Int{Value: math.MaxInt8},
	"min_int8":                 &tengo.Int{Value: math.MinInt8},
	"max_int16":                &tengo.Int{Value: math.MaxInt16},
	"min_int16":                &tengo.Int{Value: math.MinInt16},
	"max_int32":                &tengo.Int{Value: math.MaxInt32},
	"min_int32":                &tengo.Int{Value: math.MinInt32},
	"max_int64":                &tengo.Int{Value: math.MaxInt64},
	"min_int64":                &tengo.Int{Value: math.MinInt64},
